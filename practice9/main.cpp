...
int main() try
{
	...
	while (running)
	{
		...
		std::pair<glm::vec3, glm::vec3> min_max = bbox(vertices);
		std::vector<glm::vec3> min_max_v = {min_max.first, min_max.second};

		glm::vec3 c = (min_max.second + min_max.first) * 0.5f; 
